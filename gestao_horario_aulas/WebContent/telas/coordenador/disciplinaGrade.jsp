...
<body>
	...
	<jsp:useBean id="GradeDao" scope="session"
		class="br.com.gestao_horario_aulas.dao.GradeDao"></jsp:useBean>
		
	<jsp:useBean id="ProfessorDao" scope="session"
		class="br.com.gestao_horario_aulas.dao.ProfessorDao"></jsp:useBean>
		
	<jsp:useBean id="DisciplinaDao" scope="session"
		class="br.com.gestao_horario_aulas.dao.DisciplinaDao"></jsp:useBean>
	...
	<div class="nav-wrapper" style="margin-left: 50px;">
		<div class="col s12">
			<a href="listaProfessores.jsp" class="breadcrumb">Disciplina-Grade</a><a
	...
	<div id="calendar" style="margin: 50px;">
		<div class="fc-toolbar">
			...
			<div class="fc-center">
				<h2>Disciplina-Grade</h2>
			</div>
		</div>
		<div>
			<form class="col s3" action="InserirDisciplinaGrade" method="POST">
				...
				<div class="row">
					<div class="input-field col s3">
						<select required="required" name="disciplina" class="browser-default">
							<option value="" disabled selected>Selecione</option>
							<c:forEach var="disciplina" items="${DisciplinaDao.getLista()}">
				...
				<div class="col">
					...
					<div class="row">
					<div class="input-field col s3">
						<select required="required" name="grade" class="browser-default">
							<option value="" disabled selected>Selecione</option>
							<c:forEach var="grade" items="${GradeDao.getLista()}">
				...
				<div class="col">
					<label>Semestre Grade</label>

				</div>
				
					<div class="row">
					<div class="input-field col s3">
						<select required="required" name="semestre_grade" class="browser-default">
