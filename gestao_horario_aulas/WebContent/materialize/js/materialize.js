...
arget = function get(object, property, receiver) { if (object === null) object = Function.prototype; var desc = Object.getOwnPropertyDescriptor(object, property); if (desc === undefined) { var parent = Object.getPrototypeOf(object); if (parent === null) { return undefined; } else { return get(parent, property, receiver); } } else if ("value" in desc) { return desc.value; } else { var getter = desc.get; if (getter === undefined) { return undefined; } return getter.call(receiver); } };
  ...
  var Slider = function (_Component11) {
    ...
    _createClass(Slider, [{
      ...
      value: function _handleInterval() {
        ...
        if (this.$slides.length === newActiveIndex + 1) newActiveIndex = 0; // loop
																			// to
																			// start
...
;(function ($) {
  ...
  var Carousel = function (_Component18) {
    ...
    function Carousel(el, options) {
      ...
      _this61.dim = _this61.itemWidth * 2 + _this61.options.padding || 1; // Make
																			// sure
																			// dim
																			// is
																			// non
...
;(function ($) {
  ...
  var FormSelect = function (_Component20) {
    ...
    function FormSelect(el, options) {
      ...
      _this67._valueDict = {}; // Maps key to original and generated option
								// element.
        ...
        if (!this.el.disabled) {
          ...
          dropdownOptions.onOpenEnd = function (el) {
            ...
            if (_this70.dropdown.isScrollable && selectedOption.length) {
              var scrollOffset = selectedOption[0].getBoundingClientRect().top - _this70.dropdownOptions.getBoundingClientRect().top; // scroll
																																		// to
																																		// selected
																																		// option
              scrollOffset -= _this70.dropdownOptions.clientHeight / 2; // center
																		// in
																		// dropdown
